...
def handle_search(session_id,bot_reply):
    ...
    for k,v in fields.items():      
        if k not in ["location", "loc_name", "loc_lat", "loc_lon", "price_min", "price_max", "area_min", "area_max", "preferred_floor_min", "preferred_floor_max", "property_age_min", "property_age_max"]:
            mongo_filters[k] = v
